        ...
        <div class="container-fluid">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Modules List</h5>
                <div class="mb-4 mt-10 flex items-center">
                      <label for="name" class="form-label mr-4">Module Title</label>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      <tr v-for="item in paginatedItems" :key="item.id">
                        ...
                        <td class="border-bottom-0">
                          <div class="flex">
                            <router-link :to="'/admin/module/edit/'+item.id"><p class="mb-0 text-blue-500  fw-normal">edit</p></router-link>
                            <p @click="deletemd(item.id)" class="mb-0 ml-2 text-[red] fw-normal cursor-pointer">delete</p>
                          </div>
                        </td>
                      </tr>                      
                    </tbody>
...
export default {
    ...
    computed: {
        ...mapGetters('moduleModule',['getData', 'getDelete']),
        filteredItems() {
    ...
    methods : {
        ...mapActions('moduleModule', ['getModules', 'deleteModule']),
        ...mapMutations('moduleModule', ['setDelete']),
        previousPage() {
