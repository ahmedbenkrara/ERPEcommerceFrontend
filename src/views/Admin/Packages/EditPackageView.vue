    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Edit Package</h5>
              <div class="card">
                <div class="card-body">
                    <div class="mb-3">
...
export default {
    ...
    computed: {
        ...mapGetters('packageModule',['getPackageSuccess', 'getSuccess', 'getPackageData'])
    },
    watch: {
        getSuccess(value){
            if(value == true){
                ...
                this.$router.push('/admin/packages/list')
            }else if(value == false){
    ...
    methods : {
        ...mapActions('packageModule', ['getPackage', 'editPackage']),
        ...mapMutations('packageModule', ['setSuccess', 'setPackageSuccess']),
        send(){
            if(this.validation()){
                let data = {
                    data : this.data,
    ...
    mounted(){
        useHead({
            title: `Update Package | ${process.env.VUE_APP_TITLE}`,
            meta: [
                {
                name: 'description',
        ...
        this.id = this.getPackageData.id
        this.data.name = this.getPackageData.name
        this.data.price = this.getPackageData.price
        this.data.description = this.getPackageData.description
        this.setSuccess(null)
    },
    components : {
        HeaderAdmin
